...
Write-Host $InsecureLDAPBinds.Count "records saved for Domain Controller" $ComputerName
$InsecureLDAPBinds | Export-CSV -NoTypeInformation .\InsecureLDAPBinds-$ComputerName.csv
# -----------------------------------------------------------------------------
# End of Main Script
# -----------------------------------------------------------------------------
